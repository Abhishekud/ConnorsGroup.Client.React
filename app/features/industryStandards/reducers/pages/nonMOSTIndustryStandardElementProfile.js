...
import {
  INDUSTRY_STANDARDS_LOAD_INDUSTRY_STANDARD_NON_MOST_ELEMENT_DETAILS_PENDING,
  INDUSTRY_STANDARDS_LOAD_INDUSTRY_STANDARD_NON_MOST_ELEMENT_DETAILS_FULFILLED,
  INDUSTRY_STANDARDS_LOAD_INDUSTRY_STANDARD_NON_MOST_ELEMENT_DETAILS_REJECTED,
} from '../../actions';
...
export default function (state = initialState, action) {
  switch (action.type) {
    case INDUSTRY_STANDARDS_LOAD_INDUSTRY_STANDARD_NON_MOST_ELEMENT_DETAILS_PENDING:
