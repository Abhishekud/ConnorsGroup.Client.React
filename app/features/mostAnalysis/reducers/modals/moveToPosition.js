...
import {
  SHOW_MOVE_MOST_STEP_TO_POSITION,
  CANCEL_MOVE_MOST_STEP_TO_POSITION,
  SET_MOVE_MOST_STEP_TO_POSITION_MODEL_PROPERTY,
...
export default function (state = initialState, action) {
  switch (action.type) {
    case SHOW_MOVE_MOST_STEP_TO_POSITION: {
      const {mostStepId} = action.payload;
      return initialState.withMutations(map =>
        map.set('show', true)
          .setIn(['model', 'id'], mostStepId));
    }

    case CANCEL_MOVE_MOST_STEP_TO_POSITION:
    case MOVE_MOST_STEP_FULFILLED:
      return initialState;

    case SET_MOVE_MOST_STEP_TO_POSITION_MODEL_PROPERTY: {
