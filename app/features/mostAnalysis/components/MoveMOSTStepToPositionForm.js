...
class MoveMOSTStepToPositionForm extends PureComponent {
  render() {
...
MoveMOSTStepToPositionForm.propTypes = {
...
export default withAutoFocusOnEdit()(MoveMOSTStepToPositionForm);
