...
import {
  ...
  MOVE_MOST_STEP_DOWN,
  MOVE_MOST_STEP_TOP,
  MOVE_MOST_STEP_BOTTOM,
} from '../constants/moveMOSTStepActionTypes';

export default class MOSTStepMoveControls extends Component {
  ...
  handleMoveUp() {
    this.props.onMove(MOVE_MOST_STEP_UP);
  }

  handleMoveDown() {
    this.props.onMove(MOVE_MOST_STEP_DOWN);
  }

  handleMoveTop() {
    this.props.onMove(MOVE_MOST_STEP_TOP);
  }

  handleMoveBottom() {
    this.props.onMove(MOVE_MOST_STEP_BOTTOM);
  }

  handleMoveToPosition() {
    const {mostStep, onMoveToPosition} = this.props;
    onMoveToPosition(mostStep.get('id'));
  }

  render() {
    const {mostStep, disabled, onDelete, canMove} = this.props;
    ...
    return (
      <div className="move-controls">
        ...
        <DropdownButton id={`context-menu-${mostStep.get('id')}`} bsStyle="link"
          disabled={disabled}
...
MOSTStepMoveControls.propTypes = {
