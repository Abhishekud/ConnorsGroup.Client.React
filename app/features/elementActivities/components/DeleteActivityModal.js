...
class DeleteActivityModal extends Component {
  ...
  handleConfirm() {
    const {deleteActivity, model, clearSelectedActivity, loadSelectListOptions, router} = this.props;

    deleteActivity(model.get('id'))
      .then(() => {
        clearSelectedActivity();
        loadSelectListOptions(ELEMENT_ACTIVITIES);
      })
      .catch(error => handleApiError(error, router, 'An error occurred while attempting to delete the Activity.', 'Error'));
  }
...
export default withRouter(connect(
  mapStateToProps,
  {
    handleCancel: cancelDeleteActivity,
    deleteActivity,
    clearSelectedActivity,
