...
import {
  SHOW_IMPORT_KRONOS_TASKS_VALIDATION_ERRORS,
  CLOSE_IMPORT_KRONOS_TASKS_VALIDATION_ERRORS,
...
export default function (state = initialState, action) {
  switch (action.type) {
    case SHOW_IMPORT_KRONOS_TASKS_VALIDATION_ERRORS:
    ...
    case CLOSE_IMPORT_KRONOS_TASKS_VALIDATION_ERRORS:
      return initialState;
