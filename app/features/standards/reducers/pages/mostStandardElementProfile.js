...
import {
  LOAD_STANDARD_MOST_ELEMENT_PENDING,
  LOAD_STANDARD_MOST_ELEMENT_FULFILLED,
  LOAD_STANDARD_MOST_ELEMENT_REJECTED,
  LOAD_STANDARD_MOST_ELEMENT_REVISION_FULFILLED,
  LOAD_STANDARD_MOST_ELEMENT_REVISION_PENDING,
  LOAD_STANDARD_MOST_ELEMENT_REVISION_REJECTED,
} from '../../actions';
import {
...
export default function (state = initialState, action) {
  switch (action.type) {
    case LOAD_STANDARD_MOST_ELEMENT_PENDING:
    case LOAD_STANDARD_MOST_ELEMENT_REVISION_PENDING:
    ...
    case LOAD_STANDARD_MOST_ELEMENT_REJECTED:
