...
class MoveStandardItemToPositionForm extends PureComponent {
  render() {
...
MoveStandardItemToPositionForm.propTypes = {
...
export default withAutoFocusOnEdit()(MoveStandardItemToPositionForm);
