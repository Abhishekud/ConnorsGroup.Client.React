...
export default class StandardStatusLog extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="standard-status-log">
        ...
        {showComment ? <div className="standard-status-log-comment">{comment}</div> : null}
      </div>
    );
  }
}

StandardStatusLog.propTypes = {
