...
import {
  deleteElement,
  editMOSTElement,
  setEditMOSTElementWorkingModelProperty,
  updateMOSTElement,
  cancelEditMOSTElement,
  showDeleteElement,
  showDuplicateElement,
  toggleMOSTElementStatusLogComment,
} from '../actions';
import {
  showSelector,
...
import {ARCHIVE, PRODUCTION} from '../../standards/constants/standardStatuses';
...
class MOSTElementProfileSidebar extends Component {
  ...
  handleFieldChange(event) {
    ...
    this.props.setEditMOSTElementWorkingModelProperty(name, value);
  }

  handleClickComment(commentId) {
    this.props.toggleMOSTElementStatusLogComment(commentId);
  }

  handleSave(event) {
    event.preventDefault();

    const {showConfirmOpenMassUpdate, updateMOSTElement, pristineModel, workingModel, router} = this.props;
    ...
    updateMOSTElement(workingModel)
  ...
  handleDuplicate() {
    ...
    showDuplicateElement(pristineModel.set('name', `${pristineModel.get('name')} - Copy`), elementTypes.MOST);
  }

  handleCancel() {
    this.props.cancelEditMOSTElement();
  }
    ...
    return (
      <Sidebar closeable={false}>
        ...
        <div className="sidebar-scrollable">
          ...
          <ConfirmOpenMassUpdateModal elementType={elementTypes.MOST} />
        </div>
      </Sidebar>
    );
  }
