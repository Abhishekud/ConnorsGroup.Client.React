...
import {
  CANCEL_CREATE_CHARACTERISTIC_SET,
  CREATE_CHARACTERISTIC_SET_FULFILLED,
  CREATE_CHARACTERISTIC_SET_PENDING,
  CREATE_CHARACTERISTIC_SET_REJECTED,
  SET_CREATE_CHARACTERISTIC_SET_MODEL_PROPERTY,
  SHOW_CREATE_CHARACTERISTIC_SET,
} from '../../actions';
...
export default function (state = initialState, action) {
  switch (action.type) {
    case SHOW_CREATE_CHARACTERISTIC_SET:
      return initialState.set('show', true);

    case SET_CREATE_CHARACTERISTIC_SET_MODEL_PROPERTY: {
    ...
    case CANCEL_CREATE_CHARACTERISTIC_SET:
