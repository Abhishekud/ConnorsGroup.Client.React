...
import {
  ...
  LOAD_LOCATION_DEPARTMENTS_LIST_REJECTED,
  TOGGLE_LOCATION_DEPARTMENTS_LIST_FILTERS_SIDEBAR,
  SET_LOCATION_DEPARTMENTS_LIST_FILTERS_MODEL_PROPERTY,
  CLEAR_LOCATION_DEPARTMENTS_LIST_FILTERS,
} from '../../actions';
...
export default function (state = initialState, action) {
  switch (action.type) {
    case TOGGLE_LOCATION_DEPARTMENTS_LIST_FILTERS_SIDEBAR:
    ...
    case LOAD_LOCATION_DEPARTMENTS_LIST_REJECTED:
      return state.set('applying', false);

    case SET_LOCATION_DEPARTMENTS_LIST_FILTERS_MODEL_PROPERTY: {
      const {name, value} = action.payload;
      return state.setIn(['model', name], value);
    }

    case CLEAR_LOCATION_DEPARTMENTS_LIST_FILTERS:
