...
import {
  ...
  TOGGLE_VOLUME_DRIVERS_LIST_FILTERS_SIDEBAR,
  SET_VOLUME_DRIVERS_LIST_FILTERS_MODEL_PROPERTY,
  CLEAR_VOLUME_DRIVERS_LIST_FILTERS,
} from '../../actions';
...
export default function (state = initialState, action) {
  switch (action.type) {
    case TOGGLE_VOLUME_DRIVERS_LIST_FILTERS_SIDEBAR:
    ...
    case SET_VOLUME_DRIVERS_LIST_FILTERS_MODEL_PROPERTY: {
      const {name, value} = action.payload;
      return state.setIn(['model', name], value);
    }

    case CLEAR_VOLUME_DRIVERS_LIST_FILTERS:
