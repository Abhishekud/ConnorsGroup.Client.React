...
import {closeImportVolumeDriverMappingsValidationErrors} from '../actions';
import {
  showSelector,
...
class ImportVolumeDriverMappingsValidationErrorsModal extends Component {
  ...
  handleConfirm() {
    ...
    this.props.closeImportVolumeDriverMappingsValidationErrors();
...
export default connect(
  mapStateToProps,
  {
    closeImportVolumeDriverMappingsValidationErrors,
  }
