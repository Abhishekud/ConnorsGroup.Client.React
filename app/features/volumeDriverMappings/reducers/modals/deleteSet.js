...
import {
  CANCEL_DELETE_VOLUME_DRIVER_MAPPING_SET,
  SHOW_DELETE_VOLUME_DRIVER_MAPPING_SET,
...
export default function (state = initialState, action) {
  switch (action.type) {
    case SHOW_DELETE_VOLUME_DRIVER_MAPPING_SET: {
    ...
    case CANCEL_DELETE_VOLUME_DRIVER_MAPPING_SET:
